...
SOURCES = APO_Snake.cpp Render.cpp mzapo_phys.c mzapo_parlcd.c input.cpp  #soubory ke kompilaci
SOURCES += font_prop14x16.c font_rom8x16.c font_rom8x8.c
TARGET_EXE = 2048_game 			#jmeno executable
TARGET_IP ?= 10.1.76.183
ifeq ($(TARGET_IP),)
...
#tady je potreba vybrat zpusob pripojenu na desku. 
...
SSH_OPTIONS=-i ~/Desktop/mzapo_semestralka-master/mzapo-root-key
